...
class Cell(_position: Position,_size: Size= Size(32f,32f)):Area(_position, _size) {
    ...
    private fun StringBuilder.triangle(position: Position, x1: Float, y1: Float, x2: Float, y2: Float, x3: Float, y3: Float) =
        this.append("M ${x1 + position.x} ${y1 + position.y} L ${x2 + position.x} ${y2 + position.y} L ${x3 + position.x} ${y3 + position.y} Z ")

    private fun StringBuilder.arc(position: Position, x1: Float, y1: Float, x2: Float, y2: Float, x3: Float, y3: Float) =
        this.append("M ${x1 + position.x} ${y1 + position.y} Q ${x2 + position.x} ${y2 + position.y} ${x3 + position.x} ${y3 + position.y} Z ")
